...
public class GlobalClientInterceptorRegistry implements ApplicationContextAware {
    ...
    @PostConstruct
    public void init() {
        Map<String, GlobalClientInterceptorConfigurerAdapter> map = applicationContext
                .getBeansOfType(GlobalClientInterceptorConfigurerAdapter.class);
        ...
        Collection<ClientInterceptor> globalClientInterceptors
                = getBeanNamesByTypeWithAnnotation(GRpcGlobalInterceptor.class, ClientInterceptor.class)
