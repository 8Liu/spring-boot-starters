...
public enum ReturnCodeEnum {
    ...
    MESSAGE_NULL_POINTER_EXCEPTION(1013, MessageCodeConstant.MESSAGE_NULL_POINTER_EXCEPTION),//空指针异常
    MESSAGE_RUNTIME_EXCEPTION(1014, MessageCodeConstant.MESSAGE_RUNTIME_EXCEPTION),//运行时异常
    MESSAGE_EXCEPTION(1015, MessageCodeConstant.MESSAGE_EXCEPTION);//异常
