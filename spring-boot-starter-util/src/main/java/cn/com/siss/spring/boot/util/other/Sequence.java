 ...
 * <p>
 * project name: moses-framework
 */

import cn.com.siss.spring.boot.util.exception.IdGeneratorException;
...
public class Sequence {
     ...
     */
    public Sequence(long workerId, long datacenterId) throws IdGeneratorException{
        if (workerId > maxWorkerId || workerId < 0) {
            throw new IdGeneratorException(String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
        }
